	...
	for _, ti := range []struct {
		...
		},
		{
			...
			args: []string{
				...
				"--bizflycloud-api-page-size=5000",
				"--bizflycloud-region=HN",
				"--cloudflare-proxied",
		...
		},
		{
			...
			envVars: map[string]string{
				...
				"EXTERNAL_DNS_BIZFLYCLOUD_API_PAGE_SIZE":       "5000",
				"EXTERNAL_DNS_BIZFLYCLOUD_REGION":              "HN",
